...
class TestServerInterface(SFTPServerInterface):

    pass
    

class TestServer(SFTPServe)
...
class SftpFSTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sock.bind(('localhost', 12765))
        sock.listen
        self.url = "sftp://localhost:%d/" % self.port

#    def setUp(self):
#        self.url = "sftp.//localhost"
#        self.fs = obnamlib.SftpFS(self.url)
